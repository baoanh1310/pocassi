      ...
      <div className="w-full minmd:w-4/5 flex flex-row md:flex-col sm:px-4 px-16">
        <div className="flexStart flex-1 flex-col">
          <div className="flexCenter cursor-pointer">
            ...
            <p className="dark:text-white text-nft-black-1 font-semibold text-lg ml-1">Pocassi</p>
          </div>
          <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-base mt-6">Get the latest updates</p>
          <div className="flexBetween md:w-full minlg:w-557 w-357 mt-6 dark:bg-nft-dark-2 bg-white border dark:border-nft-black-2 border-nft-gray-2 rounded-md">
        ...
        <div className="flex-1 flexBetweenStart flex-wrap ml-10 md:ml-0 md:mt-8">
          <FooterLinks heading="Pocassi" items={['Explore', 'How it Works', 'Contact Us']} />
